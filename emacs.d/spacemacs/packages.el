...
(defun spacemacs/init-ace-jump-mode ()
  (use-package ace-jump-mode
    ...
    (progn
      ...
      ;; (define-key evil-normal-state-map "SPC" 'evil-ace-jump-word-mode)
...
(defun spacemacs/init-erlang ()
  (use-package erlang
    ...
    (progn
      ...
      (add-to-list 'exec-path "/usr/local/lib/erlang/erts-6.2/bin")
      (setq erland-man-root-dir "/usr/local/lib/erlang/erts-6.2")
