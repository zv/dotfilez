...
** Symlink RC Files
   ...
   #+BEGIN_SRC sh :exports code
     ...
     (
         exec 2>&1
         cd "${DOTFILEZ}" || exit 1
         link_all dig "rc/digrc"
         link_all emacs "emacs.d" "rc/spacemacs" "rc/gnus.el" "rc/newsrc"
         link_all erl "rc/erlang"
         link_all gdb "rc/gdbinit"
         link_all git "rc/gitignore" "rc/gitconfig"
         link_all gpg "rc/gnupg"
         link_all iex "rc/iex"
         link_all node "rc/npmrc" "rc/babelrc"
         link_all psql "rc/psqlrc"
         link_all rg "rc/ripgreprc"
         link_all ruby "rc/pryrc" "rc/gemrc"
         link_all screen "rc/screenrc"
         link_all screen "rc/screenrc"
         link_all tmux "rc/tmux.conf"
         link_all top "rc/toprc"
         link_all vim "rc/vim" "rc/vimrc"
         link_all weechat "rc/weechat"
         link_all wget "rc/wgetrc"
         link_all zsh "rc/zsh" "rc/zshenv" "rc/zshrc"
         link_all Xorg "rc/Xsession" "rc/Xdefaults"

         symlink_at "rc/ssh" "$HOME/.ssh"
         symlink_at "rc/editrc" "$HOME/.editrc"
         symlink_at "rc/inputrc" "$HOME/.inputrc"
     )
   #+END_SRC
